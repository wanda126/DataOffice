...
export const LoginForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(isRegistering ? 'Error en el registro' : 'Email o contraseña incorrectos');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">DataConsult</h1>
          <p className="text-gray-600">
            {isRegistering ? 'Crea tu cuenta para comenzar' : 'Inicia sesión para acceder a tu plataforma de análisis'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {isLoading ? (isRegistering ? 'Registrando...' : 'Iniciando sesión...') : (isRegistering ? 'Crear Cuenta' : 'Iniciar Sesión')}
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            {isRegistering ? (
              ...
              <>
                Para probar la app usa: <br />
                <strong>demo@company.com</strong> o <strong>admin@company.com</strong>
                <br />
